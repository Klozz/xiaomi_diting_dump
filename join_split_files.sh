...
cat vendor_boot/dtb/14_dtbdump_Qualcomm_Technologies,_Inc._WaipioP_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/14_dtbdump_Qualcomm_Technologies,_Inc._WaipioP_SoC.dtb
rm -f vendor_boot/dtb/14_dtbdump_Qualcomm_Technologies,_Inc._WaipioP_SoC.dtb.* 2>/dev/null
